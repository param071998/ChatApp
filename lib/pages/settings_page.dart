...
class SettingsPageState extends State<SettingsPage> {
  ...
  Future uploadFile() async {
    ...
    try {
      ...
      settingProvider
        ...
        Utilities.showToast(msg: "Upload success");
      }).catchError((err) {
        setState(() {
          isLoading = false;
        });
        Utilities.showToast(msg: err.toString());
      });
    } on FirebaseException catch (e) {
      setState(() {
        isLoading = false;
      });
      Utilities.showToast(msg: e.message ?? e.toString());
    }
  }
  ...
  void handleUpdateData() {
    ...
    settingProvider
      ...
      Utilities.showToast(msg: "Update success");
    }).catchError((err) {
      setState(() {
        isLoading = false;
      });
